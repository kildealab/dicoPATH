...
#				These names are automatically generated by the TPS. Below are the formats, where 01 can be any digits and c can be any letter.
# 				-----> Eclipse v18: kVCBCT_01c01
# 				-----> Older version(s): kv_CBCT_01c
